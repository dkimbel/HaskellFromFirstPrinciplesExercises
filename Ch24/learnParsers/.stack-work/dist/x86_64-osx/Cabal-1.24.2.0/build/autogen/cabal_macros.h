...
/* package learnParsers-0.1.0.0 */
#define VERSION_learnParsers "0.1.0.0"
#define MIN_VERSION_learnParsers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "learnParsers-0.1.0.0-CNTiuoSAfnEKEKOBEqtdy"

#define CURRENT_PACKAGE_KEY "learnParsers-0.1.0.0-CNTiuoSAfnEKEKOBEqtdy"
